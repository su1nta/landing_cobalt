...
const Hero = () => {
  return (
    <div className="mt-40 mb-20 flex flex-col items-center">
      <h1 className="font-display max-w-sm sm:max-w-2xl bg-linear-to-b from-neutral-50 to-neutral-600 bg-clip-text text-center text-5xl sm:text-7xl -tracking-[5px] text-transparent italic">
      ...
      <div className="mt-20">
        <img
          src={bannerImage}
          alt="Banner Image"
          className="mobiles:max-w-sm sm:max-w-xl md:max-w-2xl lg:max-w-4xl xl:max-w-6xl 2xl:max-w-7xl rounded-lg border border-neutral-700 object-cover"
        />
      </div>
    </div>
  );
