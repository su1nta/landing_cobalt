  ...
  return (
    ...
    <div className="flex w-full justify-between">
        ...
        <div className="h-3/5 w-full mask-b-from-70%">
            ...
            <div
                className="pointer-events-none absolute inset-0 z-0 mask-b-from-50%"
                style={{
                backgroundImage: `
            ...
            <div className="relative z-10 mx-auto h-4/5 w-3/4 rounded-lg border-x border-t border-neutral-700 p-3">
                <svg
                class="absolute inset-x-0 -bottom-20 -z-10"
                ...
                <defs>
                    ...
                    <feBlend
                        ...
                        result="shape"
                    ></feBlend>
                    <feGaussianBlur result="effect1_foregroundBlur_150_1769"></feGaussianBlur>
                    </filter>
                </defs>
                </svg>
                <div className="absolute grid grid-cols-6 overflow-hidden border border-neutral-600 bg-neutral-700 top-1/2 left-1/2 h-15 w-60 -translate-x-1/2 -translate-y-1/2 rounded-md">
                    <div className="col-span-1 h-full p-2 flex items-center">
                        <img src={Warning} alt="warning sign" />
                    </div>
                    <div className="col-span-5 h-full flex flex-col justify-center">
                        <h4 className="text-sm text-neutral-300">Critical Balance Alert</h4>
                        <p className="text-xs text-neutral-400"> You will have less than $2,500 in available funds in May</p>
                    </div>
                </div>
            </div>
            </div>
        </div>
        <div className="z-10 flex h-2/5 flex-col justify-center gap-3 px-10">
            <h4 className="text-xl font-semibold text-white">
            Smart Forecasting
            </h4>
            <h6 className="text-md max-w-[95%] text-neutral-500">
        ...
        <div className="h-3/5 w-full">
            ...
            <div className="absolute bottom-0 flex h-12 w-3/4 items-center justify-between rounded-sm border border-neutral-700">
                ...
                <div className="absolute -inset-2 rounded-lg bg-linear-to-r from-sky-600 via-indigo-600 to-blue-600 opacity-0 blur-lg transition duration-300 ease-in group-hover:opacity-75" />
                </span>
            </div>
            </div>
        </div>
